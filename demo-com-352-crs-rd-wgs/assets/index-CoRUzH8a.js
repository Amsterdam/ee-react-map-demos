import{j as n}from"./jsx-runtime-DSvmvvsx.js";import{useMDXComponents as r}from"./index-DL7Mpk60.js";import{M as d,S as o}from"./index-BRPKOPNg.js";import{M as s}from"./index.stories-C4NfDSaf.js";import{t as y}from"./toGeoJSON-bFbFQtj9.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-BWUQg448.js";import"./index-BSFfngg0.js";import"./index-B2UzP9c-.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";import"./leaflet-src-Cg1j7jgN.js";/* empty css                */import"./marker-shadow-CY4RBW1r.js";import"./toGeoJSON-5N07-ynB.js";const a=`import { useEffect, useRef, useState } from 'react';
import L, {
  type LatLngTuple,
...
`,m=`// Leaflet was built before Webpack, Vite (and other build engines) were used so certain assets and elements require manual configuration
...
`;function i(t){const e={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(d,{of:s}),`
`,n.jsx(e.h1,{id:"marker-clustering-simple",children:"Marker clustering (simple)"}),`
...
`,n.jsxs(e.p,{children:["This is a simple implementation of the ",n.jsx(e.a,{href:"https://www.mapbox.com/",rel:"nofollow",children:"Mapbox"})," ",n.jsx(e.a,{href:"https://github.com/mapbox/supercluster",rel:"nofollow",children:"Supercluster library"})," in a React component."]}),`
`,n.jsxs(e.p,{children:[n.jsx(e.strong,{children:"Warning"})," This component won't work for markers with the same coordinates value. They will render on top of the previously rendered marker. For handling markers with the same coordinates, there is an ",n.jsx(e.a,{href:"./?path=/docs/react-markerclusterspiderfy--docs",children:"advanced variant of this component"})," where the clustered markers can be configured to display in a 'spider' or spiral."]}),`
`,n.jsx(e.h2,{id:"how-to-implement",children:"How to implement"}),`
`,n.jsxs(e.p,{children:["To implement marker clustering with Leaflet, there are 8 files, assuming the ",n.jsx(e.a,{href:"./?path=/docs/global-requirements--docs",children:"global requirements"})," are already implemented:"]}),`
`,n.jsxs(e.ol,{children:[`
`,n.jsxs(e.li,{children:["The React component",`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.a,{href:"#--markerclustertsx",children:"MarkerCluster.tsx"}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsxs(e.em,{children:["This is based on the ",n.jsx(e.a,{href:"./?path=/docs/react-baselayer--docs",children:"BaseMap component example"})," so includes a dependency on ",n.jsx(e.a,{href:"./?path=/docs/react-baselayer--docs#--getcrsrdts",children:n.jsx(e.code,{children:"utils/getCrsRd"})}),"."]})}),`
`]}),`
`]}),`
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["Normalizing external data",`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.a,{href:"#--utilstogeojsonts",children:"utils/toGeoJSON.ts"}),`
`,n.jsxs(e.em,{children:["(This is only required for this demo to work; it helps format the external ",n.jsx(e.code,{children:"data.json"})," array into GeoJSON format.)"]})]}),`
`]}),`
`]}),`
...
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["The cluster icon",`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--utilscreateclustericonts",children:"utils/createClusterIcon.ts"})}),`
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["Leaflet marker image files",`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[`
`,n.jsx(e.p,{children:n.jsx(e.code,{children:"import iconRetinaUrl from 'leaflet/dist/images/marker-icon-2x.png';"})}),`
`]}),`
`,n.jsxs(e.li,{children:[`
`,n.jsx(e.p,{children:n.jsx(e.code,{children:"import iconUrl from 'leaflet/dist/images/marker-icon.png';"})}),`
`]}),`
`,n.jsxs(e.li,{children:[`
`,n.jsx(e.p,{children:n.jsx(e.code,{children:"import shadowUrl from 'leaflet/dist/images/marker-shadow.png';"})}),`
`,n.jsx(e.p,{children:n.jsx(e.em,{children:"It is necessary to import these images otherwise the default cluster images will reference an incorrect URL"})}),`
`]}),`
`]}),`
`]}),`
`]}),`
`,n.jsx(e.h2,{id:"usage",children:"Usage"}),`
`,n.jsx(e.h3,{id:"1-react-component",children:"1. React component"}),`
`,n.jsx(e.h4,{id:"--markerclustertsx",children:"- MarkerCluster.tsx"}),`
`,n.jsx(o,{code:a}),`
`,n.jsx(e.h3,{id:"2-normalizing-external-data",children:"2. Normalizing external data"}),`
...
`,n.jsx(o,{code:c}),`
`,n.jsx(e.h3,{id:"4-data",children:"4. Data"}),`
`,n.jsx(e.h4,{id:"--datajson",children:"- data.json"}),`
`,n.jsx(e.p,{children:n.jsx(e.em,{children:"Code intentionally shortened"})}),`
`,n.jsx(o,{code:`${p.substring(0,800)}...`}),`
`,n.jsx(e.h3,{id:"5-the-cluster-icon",children:"5. The cluster icon"}),`
`,n.jsx(e.h4,{id:"--utilscreateclustericonts",children:"- utils/createClusterIcon.ts"}),`
`,n.jsx(o,{code:m})]})}function v(t={}){const{wrapper:e}={...r(),...t.components};return e?n.jsx(e,{...t,children:n.jsx(i,{...t})}):i(t)}export{v as default};
