import{j as n}from"./jsx-runtime-DSvmvvsx.js";import{useMDXComponents as r}from"./index-DL7Mpk60.js";import{M as d,S as t}from"./index-BRPKOPNg.js";import{M as y}from"./index.stories-DBEHwz9S.js";import{t as s}from"./toGeoJSON-bFbFQtj9.js";import"./index-B0WjJBI_.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-BWUQg448.js";import"./index-BSFfngg0.js";import"./index-B2UzP9c-.js";import"./index-DgH-xKnr.js";import"./index-DrFu-skq.js";import"./leaflet-src-Cg1j7jgN.js";import"./marker-shadow-CY4RBW1r.js";import"./toGeoJSON-5N07-ynB.js";const a=`import { useCallback, useEffect, useMemo, useRef, useState } from 'react';
import L, {
  type LatLngTuple,
...
`,c=`import type { LatLngTuple } from 'leaflet';
...
`,p=`import type { LineString, Position } from 'geojson';
...
`,g=`import type { Point } from 'geojson';
...
`,l=`import type { ClusterOptions } from './types';
import styles from './styles.module.css';
...
`,u=`function round(num: number, decimalPlaces: number = 6) {
...
`,f=`import type { LatLngBounds, LatLngBoundsLiteral } from 'leaflet';
...
`;function i(o){const e={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...o.components};return n.jsxs(n.Fragment,{children:[n.jsx(d,{of:y}),`
`,n.jsx(e.h1,{id:"marker-clustering-spiderfy",children:"Marker clustering (spiderfy)"}),`
`,n.jsxs(e.p,{children:[n.jsx(e.strong,{children:n.jsx(e.a,{href:"./?path=/docs/marker-clustering--docs",children:"Background and use cases"})})," | ",n.jsx(e.strong,{children:n.jsx(e.a,{href:"https://github.com/Amsterdam/ee-react-map-demos/tree/main/src/pages/MarkerCluster",rel:"nofollow",children:"GitHub Repo URL"})})]}),`
`,n.jsx(e.h4,{id:"table-of-contents",children:"Table of Contents"}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#requirements",children:"Requirements"})}),`
...
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:["This example is built upon the ",n.jsx(e.a,{href:"./?path=/docs/react-baselayer--docs",children:"BaseMap component example"}),"."]}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"./?path=/docs/global-requirements--docs",children:"See global requirements list"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"https://www.npmjs.com/package/supercluster",rel:"nofollow",children:"Supercluster"})}),`
`]}),`
`,n.jsx(e.p,{children:n.jsx(e.strong,{children:"For typescript:"})}),`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"https://www.npmjs.com/package/@types/geojson",rel:"nofollow",children:"@types/geojson"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"https://www.npmjs.com/package/@types/supercluster",rel:"nofollow",children:"@types/supercluster"})}),`
`]}),`
`,n.jsx(e.h2,{id:"description",children:"Description"}),`
`,n.jsxs(e.p,{children:["This is a simple implementation of the ",n.jsx(e.a,{href:"https://www.mapbox.com/",rel:"nofollow",children:"Mapbox"})," ",n.jsx(e.a,{href:"https://github.com/mapbox/supercluster",rel:"nofollow",children:"Supercluster library"})," in a React component. The static data for this example has intentionally been duplicated at two locations: ",n.jsx(e.strong,{children:n.jsx(e.a,{href:"https://data.amsterdam.nl/data/bag/nummeraanduiding/0363200000450029?center=52.3757212%2C4.9183681&term=Dijksgracht+19%2C+1019BT+Amsterdam&zoom=14",rel:"nofollow",children:"Dijksgracht 19"})})," and ",n.jsx(e.strong,{children:n.jsx(e.a,{href:"https://data.amsterdam.nl/data/bag/nummeraanduiding/0363200000411392?center=52.3957353%2C4.9069465&term=Papaverweg+33%2C+1032KE+Amsterdam&zoom=14",rel:"nofollow",children:"Papaverweg 33"})}),"."]}),`
`,n.jsxs(e.p,{children:[n.jsx(e.strong,{children:"Heads up"})," if you are working with data that has no records with the same geometry values, there is a ",n.jsx(e.a,{href:"./?path=/story/react-markercluster--docs",children:"simpler version"})," of this component available."]}),`
`,n.jsx(e.h3,{id:"data-handling",children:"Data handling"}),`
`,n.jsxs(e.p,{children:["In the ",n.jsx(e.code,{children:"useMemo"})," call (lines 112-125) we process the data in two methods:"]}),`
`,n.jsxs(e.ol,{children:[`
`,n.jsxs(e.li,{children:[`
`,n.jsxs(e.p,{children:["The primary call (",n.jsx(e.code,{children:"getMapData"}),") could exist in an API/backend-for-frontend application. This method returns data with features inside the map's current bounding box and creates a supercluster object. The supercluster object contains an extra data property ",n.jsx(e.code,{children:"expansion_zoom"}),", which is used later in cluster event listeners."]}),`
`]}),`
`,n.jsxs(e.li,{children:[`
`,n.jsxs(e.p,{children:["The secondary method (",n.jsx(e.code,{children:"processFeatures"}),") separates the markers and cluster items. For markers with the same geometry values, it also generates the GeoJSON for the re-generated cluster markers (new markers surrounding the initial marker positioning)."]}),`
`]}),`
`]}),`
`,n.jsx(e.h3,{id:"display-options",children:"Display options"}),`
`,n.jsx(e.p,{children:"There are two options for how to display the cluster:"}),`
`,n.jsxs(e.ol,{children:[`
`,n.jsxs(e.li,{children:[`
`,n.jsxs(e.p,{children:[n.jsx(e.code,{children:"clusterShape"})," = ",n.jsx(e.code,{children:"circle"})," or ",n.jsx(e.code,{children:"spiral"})]}),`
`,n.jsx(e.p,{children:n.jsx(e.em,{children:"Circle draws the markers around the original marker geometry. Spiral draws the markers in spiral curve around the original marker geometry."})}),`
`]}),`
`,n.jsxs(e.li,{children:[`
`,n.jsxs(e.p,{children:[n.jsx(e.code,{children:"spiderfyOnMaxZoom"}),": ",n.jsx(e.code,{children:"true"})," or ",n.jsx(e.code,{children:"false"})]}),`
`,n.jsx(e.p,{children:n.jsxs(e.em,{children:["This draws straight lines from the new clustered marker to the original geometry point. It works best with ",n.jsx(e.code,{children:"clusterShape=circle"})]})}),`
`]}),`
`]}),`
`,n.jsx(e.h2,{id:"how-to-implement",children:"How to implement"}),`
`,n.jsxs(e.p,{children:["To implement marker clustering with Leaflet, there are 11 files, assuming the ",n.jsx(e.a,{href:"./?path=/docs/global-requirements--docs",children:"global requirements"})," are already implemented:"]}),`
`,n.jsxs(e.ol,{children:[`
`,n.jsxs(e.li,{children:["The React component",`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.a,{href:"#--markerclusterspiderfytsx",children:"MarkerClusterSpiderfy.tsx"})," (",n.jsxs(e.em,{children:["This is based on the ",n.jsx(e.a,{href:"./?path=/docs/react-baselayer--docs",children:"BaseMap component example"})," so includes a dependency on ",n.jsx(e.a,{href:"./?path=/docs/react-baselayer--docs#--getcrsrdts",children:n.jsx(e.code,{children:"utils/getCrsRd"})}),"."]}),")"]}),`
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["Data handling",`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--getmapdatats",children:"getMapData.ts"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--processfeaturests",children:"processFeatures.ts"})}),`
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["The CSS styles",`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--stylesmodulecss",children:"styles.module.css"})}),`
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["Types for data (typescript only)",`
`,n.jsxs(e.ul,{children:[`
`,n.jsxs(e.li,{children:[n.jsx(e.a,{href:"#--typests",children:"types.ts"})," ",n.jsx(e.em,{children:"(These have been kept minimal and are primarily for examples.)"})]}),`
`]}),`
`]}),`
...
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["Map and cluster options and styles",`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--mapstylests",children:"mapStyles.ts"})}),`
`]}),`
`]}),`
`,n.jsxs(e.li,{children:["Utils",`
`,n.jsxs(e.ul,{children:[`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--utilsroundnumberts",children:"utils/roundNumber.ts"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--utilscreateclustershapests",children:"utils/createClusterShapes.ts"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--utilstogeojsonts",children:"utils/toGeoJSON.ts"})}),`
`,n.jsx(e.li,{children:n.jsx(e.a,{href:"#--utilstoboundsliteralts",children:"utils/toBoundsLiteral.ts"})}),`
`]}),`
`]}),`
`]}),`
`,n.jsx(e.h2,{id:"usage",children:"Usage"}),`
`,n.jsx(e.h3,{id:"1-the-react-component",children:"1. The React component"}),`
`,n.jsx(e.h4,{id:"--markerclusterspiderfytsx",children:"- MarkerClusterSpiderfy.tsx"}),`
`,n.jsx(t,{code:a}),`
`,n.jsx(e.h3,{id:"2-data-handling",children:"2. Data handling"}),`
`,n.jsx(e.h4,{id:"--getmapdatats",children:"- getMapData.ts"}),`
`,n.jsx(t,{code:c}),`
`,n.jsx(e.h4,{id:"--processfeaturests",children:"- processFeatures.ts"}),`
`,n.jsx(t,{code:p}),`
`,n.jsx(e.h3,{id:"3-css-styles",children:"3. CSS styles"}),`
`,n.jsx(e.h4,{id:"--stylesmodulecss",children:"- styles.module.css"}),`
`,n.jsx(t,{code:m}),`
`,n.jsx(e.h3,{id:"4-types-for-data",children:"4. Types for data"}),`
`,n.jsx(e.h4,{id:"--typests",children:"- types.ts"}),`
`,n.jsx(t,{code:g}),`
`,n.jsx(e.h3,{id:"5-data",children:"5. Data"}),`
`,n.jsx(e.h4,{id:"--datajson",children:"- data.json"}),`
`,n.jsx(e.p,{children:n.jsx(e.em,{children:"Code intentionally shortened"})}),`
`,n.jsx(t,{code:`${P.substring(0,800)}...`}),`
`,n.jsx(e.h3,{id:"6-map-styles",children:"6. Map Styles"}),`
`,n.jsx(e.h4,{id:"--mapstylests",children:"- mapStyles.ts"}),`
`,n.jsx(t,{code:l}),`
`,n.jsx(e.h3,{id:"7-utils",children:"7. Utils"}),`
`,n.jsx(e.h4,{id:"--utilsroundnumberts",children:"- utils/roundNumber.ts"}),`
`,n.jsx(t,{code:u}),`
`,n.jsx(e.h4,{id:"--utilscreateclustershapests",children:"- utils/createClusterShapes.ts"}),`
`,n.jsx(t,{code:h}),`
`,n.jsx(e.h4,{id:"--utilstogeojsonts",children:"- utils/toGeoJSON.ts"}),`
`,n.jsx(t,{code:s}),`
`,n.jsx(e.h4,{id:"--utilstoboundsliteralts",children:"- utils/toBoundsLiteral.ts"}),`
`,n.jsx(t,{code:f})]})}function B(o={}){const{wrapper:e}={...r(),...o.components};return e?n.jsx(e,{...o,children:n.jsx(i,{...o})}):i(o)}export{B as default};
