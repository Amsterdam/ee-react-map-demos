...
This project aims to include demos and examples of common use-cases of maps. The selected map library is [Leaflet](https://leafletjs.com/) implemented in the frontend library [React](https://react.dev/).
...
### TODO Change these blocks below to screenshots + description + links to each demo?
