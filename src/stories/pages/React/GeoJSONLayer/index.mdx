...
To accomplish the Amsterdam GeoJSONLayer there are 4 files, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
