...
import * as BaseLayerRDStories from './index.stories';
import BaseLayerRD from '@/pages/BaseLayerRD/BaseLayerRD?raw';
import styles from '@/pages/BaseLayerRD/styles.module.css?raw';
import getCrsRd from '@/utils/getCrsRd?raw';

<Meta of={BaseLayerRDStories} />

# BaseLayerRD

**[Background](./?path=/docs/leaflet-layers--docs#tilelayer)** | **<a href="https://github.com/Amsterdam/ee-react-map-demos/tree/main/src/pages/BaseLayerRD" target="_blank">GitHub Repo URL</a>**
...
To accomplish the Amsterdam base/tile layer there are 3 files, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
1. The React components
    * [BaseLayerRD.tsx](#--baselayerRDtsx)
