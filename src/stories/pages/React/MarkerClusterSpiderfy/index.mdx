...
To implement marker clustering with Leaflet, there are 11 files, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
