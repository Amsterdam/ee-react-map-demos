...
To implement marker clustering with Leaflet, there are 8 files, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
