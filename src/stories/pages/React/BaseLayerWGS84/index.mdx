...
import * as BaseLayerWGS84Stories from './index.stories';
import BaseLayerWGS84 from '@/pages/BaseLayerWGS84/BaseLayerWGS84?raw';
import styles from '@/pages/BaseLayerWGS84/styles.module.css?raw';

<Meta of={BaseLayerWGS84Stories} />

# BaseLayerWGS84

**[Background](./?path=/docs/leaflet-layers--docs#tilelayer)** | **<a href="https://github.com/Amsterdam/ee-react-map-demos/tree/main/src/pages/BaseLayerWGS84" target="_blank">GitHub Repo URL</a>**
...
To accomplish the Amsterdam base/tile layer there are three files:
1. The React components
    * [BaseLayerWGS84.tsx](#--baselayerWGS84tsx)
