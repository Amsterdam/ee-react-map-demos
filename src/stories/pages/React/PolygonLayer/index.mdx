...
**[Background and use cases](./?path=/docs/leaflet-layers--docs#polygon)** | **<a href="https://github.com/Amsterdam/ee-react-map-demos/tree/main/src/pages/PolygonLayer" target="_blank" className="sbdocs sbdocs-a">GitHub Repo URL</a>**
