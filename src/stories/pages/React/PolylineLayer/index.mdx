...
**[Background and use cases](./?path=/docs/leaflet-layers--docs#polyline)** | **<a href="https://github.com/Amsterdam/ee-react-map-demos/tree/main/src/pages/PolylineLayer" target="_blank" className="sbdocs sbdocs-a">GitHub Repo URL</a>**
