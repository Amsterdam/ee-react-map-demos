...
To implement a Leaflet polygon layer there are three files required, this example also uses an extra file for demo data, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
