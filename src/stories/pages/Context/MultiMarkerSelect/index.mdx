...
To accomplish the MultiMarkerSelect component, there are 9 files, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
