...
To accomplish the ZoomControls component, there are 6 files, assuming the [global requirements](./?path=/docs/global-requirements--docs) are already implemented:
