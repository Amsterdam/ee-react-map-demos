...
#### [Multiple Marker Select](./?path=/docs/react-context-examples-multimarkerselect--docs) _(Advanced)_
...
#### [Position](./?path=/docs/react-context-examples-position--docs) _(Simple)_
...
#### [Single marker select](./?path=/docs/react-context-examples-singlemarkerselect--docs) _(Advanced)_
...
#### [Zoom controls](./?path=/docs/react-context-examples-zoomcontrols--docs) _(Simple)_
...
#### [Full-screen zoom controls](./?path=/docs/react-context-examples-designsystempagezoomcontrols--docs) _(Simple)_
...
provides a way to share values between components without passing props through
every level of the component tree. This is particularly useful for global state
management, for example, theme settings, user authentication, and localization,
where certain data needs to be accessible by many components at different levels
of the hierarchy.
