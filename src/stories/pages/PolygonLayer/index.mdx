...
**[Background](../?path=/docs/leaflet-layers--docs#polygon)** | **<a href="https://github.com/Amsterdam/ee-react-map-demos/tree/main/src/pages/PolygonLayer" target="_blank">GitHub Repo URL</a>**
...
4. Demo data (1 file)
    - [data.json](#1-datajson) *- This data represents the coordinates for Vondelpark.*
